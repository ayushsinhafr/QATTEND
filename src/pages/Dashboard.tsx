...
const Dashboard = () => {
  ...
  // Redirect parents to parent dashboard instead of regular dashboard
  useEffect(() => {
    if (profile && (profile.role as string) === 'parent') {
      // For registered parents, redirect to parent dashboard
  ...
  } else if (profile && (profile.role as string) === 'parent') {
