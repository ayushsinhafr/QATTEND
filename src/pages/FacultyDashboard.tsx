  ...
  const handleStartFaceRecognitionSession = async (classInfo: any) => {
    try {
      ...
      if (token) {
        ...
        // Don't show the attendance session dialog again - go directly to QR display
        // setShowAttendanceSession(true); // REMOVED: This was causing the duplicate popup
        ...
        {qrCodeUrl && selectedClass && (
          <Card className="mb-12 border border-blue-200 shadow-2xl shadow-blue-500/20 bg-gradient-to-br from-blue-50 to-indigo-50">
            ...
            <CardContent className="text-center py-8">
              ...
              {/* Close QR Button - Centered below QR code */}
              <div className="flex justify-center">
                <Button 
                  ...
                  className="bg-white dark:bg-slate-800 hover:bg-red-50 dark:hover:bg-red-950/20 border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 hover:border-red-300 dark:hover:border-red-700 px-8 py-3 text-base font-medium rounded-xl transition-all duration-200"
                  size="lg"
                >
                  Close QR Code
                </Button>
